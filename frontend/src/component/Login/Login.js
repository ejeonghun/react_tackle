   ...
   <div>
    ...
    <div className="service">
      <ul style={{listStyle:"none", padding:"0"}}>
        ...
        개인정보보호법에 따라 "Local people" 에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.

 

        1. 수집하는 개인정보
        이용자는 회원가입을 하지 않아도 정보 검색, 게시판 열람 등 대부분의 "Local People" 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 글쓰기, 댓글작성 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, "Local People" 는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.

        

        2. 회원가입 시점에 "Local People" 가 이용자로부터 수집하는 개인정보는 아래와 같습니다.
